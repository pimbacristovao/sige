              ...
              <th colspan="5">
                <span class="pull-right">
                  <div class="btn-group btn-group-justified">
                    <a href="#modal-num-processo" data-toggle="modal" class="btn btn-sm btn-default m-b-10 p-l-5">
                      <i class="fa fa-plus mr-2"></i>ADICIONAR Nº DE PROCESSO
                    </a>
                    <!------------------------------------------------------------------------------------------>
                    <a href="#modal-matricula" data-toggle="modal" class="btn btn-sm btn-default m-b-10 p-l-5">
                      <i class="fa fa-plus mr-2"></i>REALIZAR MATRICULA
                    </a>
                    <!------------------------------------------------------------------------------------------>
                    <a href="#modal-encarregados" data-toggle="modal" class="btn btn-sm btn-default m-b-10 p-l-5">
                ...
                <span class="pull-left">
                  ...
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-none">
                      <li>
                        <a href="<?= site_url('secretaria/aluno/editar/'.$aluno['id_aluno']) ?>">
                          <i class="fa fa-edit mr-2"></i>EDITAR ALUNO
                        </a>
                      </li>
                      <li>
                        <a href="<?= site_url('secretaria/aluno/carregar_imagem?id_aluno='.$aluno['id_aluno']) ?>">
