...
<head>
    <meta charset="utf-8" />
    <title>SiGE | Sistema de Gestão Escolar | Recuperar palavra-passe</title>
    <meta content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport" />
    <meta content="" name="description" />
    <meta content="" name="Pimba Cristovão" />
	...
	<link href="<?= base_url(); ?>_assets/css/default/style_page_recuperar_password.css" rel="stylesheet">
    <!-- ================== FIM BASE CSS STYLE ================== -->
    ...
    <link rel="stylesheet" href="<?=base_url(); ?>_assets/plugins/jcrop/css/ie10-viewport-bug-workaround.css" type="text/css" />
    <!-- ===================== INICIO BASE JS ==================== -->
